                ...
                <div className="container py-1">
                    ...
                    <div className="collapse navbar-collapse ps-md-5" id="navbarSupportedContent">
                        <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                           ...
                           <li className="nav-item me-3">
                                <a role="button" className={`${style.navItem} global-text-primary nav-link active fs-5`} aria-current="page" 
                                onClick={() => homeMyNftToggleHandler("mynft")}>My NFT</a> {/* global-active */}
                            </li>

                            <li className="nav-item me-3">
                                <a role="button" className={`${style.navItem} global-text-primary nav-link active fs-5`} aria-current="page" 
                                onClick={() => homeMyNftToggleHandler("reselNft")}>List NFT For Resell</a> {/* global-active */}
                            </li>
                        

                            </ul>
                        
                        {userSigned ? userType == "artist" ? 
