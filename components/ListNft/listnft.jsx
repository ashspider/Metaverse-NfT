import style from './resell.module.css'
...
const Resellnft = () => {
  ...
  if (loadingState === 'loaded' && !nfts.length) return (<h1 className='ol-md-6 col-sm-12'> NO Items to Resell</h1>)
                ...
                <>
                  <div key={i} className='col-md-3 col-12 p-2'>
                    <div className='global-background-secondary p-2'>
                      ...
                      <button className="btn btn-primary text-nowrap lh-lg col-12 fw-bold rounded-pill" onClick={() => listNFT(nft)}>List </button>
                      </div>
