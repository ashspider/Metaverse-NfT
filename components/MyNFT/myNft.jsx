...
const MyNft = () => {
  ...
  //if (loadingState1 === 'loaded' && !nfts1.length) return (<h1 className='ol-md-6 col-sm-12'> NO items in Marketplace</h1>)
                  ...
                  <div key={i} className='col-md-3 col-12 p-2'>
                    <div className='global-background-secondary p-2'>
                      ...
                      <div className='text-center p-2'>
                        ...
                        {/* <button className={`${style.buyNft}`} onClick={() => listNFT(nft)}>List your NFT</button> */}
